...
cp -r /home/ashfaqf/.config/opencode/context ~/.opencode/
```
...
**Context-aware:** Agents automatically load patterns from `/home/ashfaqf/.config/opencode/context/` to follow your coding standards.
...
nano ~//home/ashfaqf/.config/opencode/context/project/project-context.md
...
A: Edit `~//home/ashfaqf/.config/opencode/context/project/project-context.md` - agents automatically load this file.
