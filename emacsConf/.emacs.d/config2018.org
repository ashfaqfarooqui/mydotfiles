...
: sidebar-toggle
* History
Provides the ability to have commands and their history saved so that whenever you return to work, you can re-run things as you need them. This is not a radical function, it is part of a good user experience. [[https://github.com/rememberYou/.emacs.d/blob/master/config.org/#alert]]
#+begin_src emacs-lisp
(use-package savehist
  ...
  (savehist-file (expand-file-name (format "%s/emacs/history" "./emacs.d/")))
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        (quote ( ("t" "todo task" entry (file+headline "Phd.org" "Tasks")
