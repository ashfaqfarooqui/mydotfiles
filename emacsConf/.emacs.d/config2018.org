...
#+RESULTS:
| a | Appointment | entry | (file (org-file-path gcal.org))         | * %?\n\n%^T\n\n:PROPERTIES:\n\n:END:\n\n                                                                                                    |           |   |               |   |                   |   |
| t | todo work   | entry | (file+headline Phd Notebook.org Tasks)  | * TODO %a %?\nSCHEDULE: %(org-insert-time-stamp (org-read-date nil t "+2d"))                                                               |           |   |               |   |                   |   |
| b | Blog idea   | entry | (file (org-file-path blog-ideas.org))   | * TODO %?\n                                                                                                                                |           |   |               |   |                   |   |
| p | Phd Notes   | entry | (file (org-file-path Phd Notebook.org)) |                                                                                                                                            |           |   |               |   |                   |   |
| N | Notes       | entry | (file org-index-file)                   | * %? :NOTE:\n                                                                                                                              |           |   |               |   |                   |   |
| i | Inbox       | entry | (file org-index-file)                   | * TODO %?\nSCHEDULED: %^{Scheduled to begin}t DEADLINE:\n  %^{Deadline}T\n                                                                       |           |   |               |   |                   |   |
| r | respond     | entry | (file org-index-file)                   | * NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n                                                                             | :clock-in | t | :clock-resume | t | :immediate-finish | t |
| h | Habit       | entry | (file org-index-file)                   | * NEXT %?\n%U\n%a\nSCHEDULED: %(format-time-string "%<<%Y-%m-%d %a .+1d/3d>>")\n:PROPERTIES:\n:STYLE: habit\n:REPEAT_TO_STATE: NEXT\n:END:\n |           |   |               |   |                   |   |
...
#+BEGIN_SRC emacs-lisp
  (use-package paradox
    ...
    (setq paradox-github-token "8267f820b74c7e358f97163dd5ab3288b38e801c")
#+END_SRC

#+RESULTS:
: 8267f820b74c7e358f97163dd5ab3288b38e801c
