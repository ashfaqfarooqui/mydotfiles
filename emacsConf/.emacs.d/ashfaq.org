...
*** Settings
   ...
   #+begin_src emacs-lisp
     (setq org-log-done t
           org-todo-keywords '((sequence "TODO" "INPROGRESS" "DONE" "DEFFERED" "WAITING"))
           org-todo-keyword-faces '(("INPROGRESS" . (:foreground "blue" :weight bold))
                                    ("DEFFERED" . (:foreground "red" :weight book))
                                    ("WAITING" . (:background "red" :weight book))
...
- Keep a running grocery list in =~/Phd Notebook.org=, and
- Maintain a todo list in =~index.org=.
...
*** Find files
    ...
    #+end_src
;; *** Scala x   Setup configuration for scala mode and add hook to run ensime within scala-mode
    #+begin_src emacs-lisp
      (require 'ensime)
...
that seems to be with the =listing= package. =pdflatex= usually disallows shell commands;
this enables that.

#+BEGIN_SRC emacs-lisp
  (setq org-latex-pdf-process
        '("pdflatex -shell-escape -interaction nonstopmode -output-directory %o/exports %f/exports"
          "pdflatex -shell-escape -interaction nonstopmode -output-directory %o/exports %f/exports"
          "pdflatex -shell-escape -interaction nonstopmode -output-directory %o/exports %f/exports"))
#+END_SRC
