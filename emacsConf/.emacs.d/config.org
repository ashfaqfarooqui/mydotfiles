...
(define-key z-map (kbd "C-c r") 'cleanup-region)
(define-key z-map (kbd "C-c b") 'cleanup-buffer)
...
(define-key z-map (kbd "h m") 'hydra-multiple-cursors/body)
(define-key z-map (kbd "h g") 'hydra-git-gutter/body)
(define-key z-map (kbd "h c") 'hydra-mu4e-headers/body)
(define-key z-map (kbd "h i") 'soo-ivy/body)
